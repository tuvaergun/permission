<?php namespace Tuva\Permission\Traits;

use Tuva\Permission\Helper\Helper;
...
trait HasPermission
{
    ...
    */
    ...
    {
        $model = config('tuva.permission', 'Tuva\Permission\Models\Eloquent\Permission');
    ...
    public function can($permission, $operator = null)
    {
        ...
        $model = config('tuva.role', 'Tuva\Permission\Models\Eloquent\Role');
